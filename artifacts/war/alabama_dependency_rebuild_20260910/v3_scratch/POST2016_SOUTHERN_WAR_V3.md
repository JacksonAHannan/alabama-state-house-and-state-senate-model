...
All 3,660 strict races after 2016 were scored. Dexter Grimsley: raw gap D+18.590, fitted structural gap D+5.324, WAR D+13.266.

## Lag and finance

On lag-context races, mean absolute fitted lag is 4.123 points in 2018 and 2.108 in 2022. Missing lag context remains explicit.
...
Model run: `WAR-POST2016-V3-58FF952DE4FACDAF75BD`.
