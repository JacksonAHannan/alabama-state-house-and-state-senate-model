...
|---|---:|---:|---:|---:|---:|---:|---|
| cmo_expectation__blend100 | 22.85 | -1.76 | [-2.71, -0.76] | 10.86 | 9.16 | 5 | pass |
| cmo_expectation__blend20 | 22.88 | -1.73 | [-2.73, -0.72] | 10.98 | 9.54 | 6 | pass |
...
| demographics_regions__ridge20__blend20 | 23.13 | -1.48 | [-2.70, -0.11] | 11.70 | 10.91 | 4 | fail |
| all_plus_candidate_history__ridge100__blend20 | 23.14 | -1.47 | [-2.70, -0.13] | 11.74 | 10.92 | 4 | fail |
| demographics_regions_finance_incumbency__ridge100__blend20 | 23.14 | -1.47 | [-2.70, -0.13] | 11.74 | 10.92 | 4 | fail |
| demographics__ridge20__blend20 | 23.14 | -1.47 | [-2.70, -0.08] | 11.73 | 10.97 | 4 | fail |
| demographics_regions_finance__ridge100__blend20 | 23.15 | -1.46 | [-2.70, -0.11] | 11.76 | 10.95 | 4 | fail |
| demographics_regions__ridge100__blend20 | 23.15 | -1.46 | [-2.69, -0.16] | 11.76 | 10.96 | 4 | fail |
| demographics__ridge100__blend20 | 23.16 | -1.46 | [-2.70, -0.10] | 11.77 | 10.97 | 4 | fail |

## Past-only selection audit

A selector restricted to earlier held-out cycles produced mean MAE 24.09, versus 24.61 for always using the basic model. It selected the basic model in 2 of 6 cycles.

## 2026 basic views

The 75% view is -2.26 points from default. The continued-nationalization 125% view is +2.26 points from default. The 125% view is explicitly untestable and cannot win the statistical tournament.
