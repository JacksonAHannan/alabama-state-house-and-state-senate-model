...
The fundraising normalization uses the current cycle's fundraising and district covariates but no election result. Missing campaign-finance observations remain missing and receive no fundraising adjustment. Current finance coverage is 45 of 48 contested Democratic-versus-Republican races.
