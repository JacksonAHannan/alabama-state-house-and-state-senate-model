...
def build_attribution_panel(tag="section"):
    sources = [
        ...
        ("State campaign finance", "FollowTheMoney / National Institute on Money in Politics", "Candidate fundraising totals used by the fundraising-adjusted sensitivity specification.", "https://www.followthemoney.org/"),
...
<header><div class="mast"><div><div class="brand">Jackson Hannan</div><div class="tag">Alabama legislative models</div></div><nav class="nav" aria-label="Site navigation"><a href="index.html">Forecast</a><a href="cmo.html" aria-current="page">CMO</a><a href="legislators.html">Issue atlas</a><a href="methodology.html">Forecast methodology</a><a href="cmo-methodology.html">CMO methodology</a><a href="https://github.com/JacksonAHannan" target="_blank" rel="me noopener">GitHub</a></nav></div></header>
...
<section class="model-status"><div class="status-card feature"><span>Historical CMO architecture</span><b>Cross-fitted contextual baseline</b><p>Each candidate is compared with an out-of-fold expectation based on the district, election cycle, chamber, incumbency, prior presidential context, and demographics.</p></div><div class="status-card"><b>__CYCLE_COUNT__</b><span>Historical cycles</span></div><div class="status-card"><b>__ELIGIBLE_RACES__</b><span>Eligible D vs. R races</span></div><div class="status-card"><b>3</b><span>CMO specifications</span></div></section>
...
</style></head><body><header><div class="mast"><div><div class="brand">Jackson Hannan</div><div class="tag">Alabama legislative models</div></div><nav class="nav" aria-label="Site navigation"><a href="index.html">Forecast</a><a href="cmo.html">CMO</a><a href="legislators.html">Issue atlas</a><a href="methodology.html">Forecast methodology</a><a href="cmo-methodology.html" aria-current="page">CMO methodology</a><a href="https://github.com/JacksonAHannan">GitHub</a></nav></div></header>
...
<section id="versions"><h2>5. Three CMO specifications</h2><p><b>Total CMO</b>, the headline measure, excludes spending. <b>Resource-adjusted CMO</b> includes relative campaign spending and a finance-availability flag. <b>Fundraising-adjusted CMO</b> is a secondary sensitivity specification using FollowTheMoney fundraising totals; missing candidates remain unknown rather than being assigned zero dollars.</p><p>None supports a causal claim. Fundraising is endogenous, finance coverage is incomplete, and money raised is not the same as money efficiently deployed. The explorer reports whether all three agree on direction and their total range.</p></section>
