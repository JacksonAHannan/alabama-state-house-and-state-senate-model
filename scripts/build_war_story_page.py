...
<section class="model-status"><div class="status-card feature"><span>Historical CMO architecture</span><b>Cross-fitted contextual baseline</b><p>Each candidate is compared with an out-of-fold expectation based on the district, election cycle, chamber, incumbency, prior presidential context, and demographics.</p></div><div class="status-card"><b>4</b><span>Historical cycles</span></div><div class="status-card"><b>__ELIGIBLE_RACES__</b><span>Eligible D vs. R races</span></div><div class="status-card"><b>2</b><span>CMO specifications</span></div></section>
