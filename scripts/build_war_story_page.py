...
<section id="data"><h2>2. Coverage</h2><p>The model covers __ELIGIBLE_RACES__ contested Democratic–Republican Alabama House and Senate races from 1994 through 2022. It publishes 1,018 candidate-cycle rows. Nominal contests remain visible but are excluded from replacement-level fitting.</p></section>
...
<section id="data"><h2>2. Coverage</h2><p>The model covers __ELIGIBLE_RACES__ contested Democratic–Republican Alabama House and Senate races from 1994 through 2022 and publishes 1,018 candidate-cycle rows.</p></section>
...
<section id="data"><h2>3. Coverage</h2><p>The model covers __ELIGIBLE_RACES__ contested Democratic&ndash;Republican Alabama House and Senate races from 1994 through 2022 and publishes 1,018 candidate-cycle rows.</p></section>
