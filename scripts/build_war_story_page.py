...
@media(max-width:780px){.nav{display:none}.brand{font-size:27px}main{padding:44px 18px}.story-head h1{letter-spacing:-2px}.dashboard{grid-template-columns:1fr}.map-panel{border-right:0;border-bottom:1px solid var(--line);padding:22px 16px}.summary{grid-template-columns:1fr 1fr}.summary div:nth-child(2){border-right:0}.summary div:nth-child(-n+2){border-bottom:1px solid var(--line)}.explorer-top{display:block}.detail{min-height:390px}.controls{grid-template-columns:1fr}.controls button{flex:1 0 29%}}
</style></head><body>
...
<section class="model-status"><div class="status-card feature"><span>Historical CMO architecture</span><b>Cross-fitted contextual baseline</b><p>Each candidate is compared with an out-of-fold expectation based on the district, election cycle, chamber, incumbency, prior presidential context, and demographics.</p></div><div class="status-card"><b>__CYCLE_COUNT__</b><span>Historical cycles</span></div><div class="status-card"><b>__ELIGIBLE_RACES__</b><span>Eligible D vs. R races</span></div><div class="status-card"><b>2</b><span>CMO specifications</span></div></section>
