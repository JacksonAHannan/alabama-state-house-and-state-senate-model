...
def build_payload():
    ...
    payload={"meta":{"pollAsOf":poll_date.isoformat(),"buildDate":build_date.isoformat(),
                     ...
                     "model":DEFAULT_MODEL,"version":"2026.08.18-cmo-expectation-views"},
...
<details class="quick-method"><summary>How the two forecast views work</summary><ol><li>Both views begin with the district's 2024 presidential margin adjusted for the projected 2026 national environment.</li><li><b>Basic</b> adds 20% of the expected-performance adjustment used by the CMO framework.</li><li><b>Fundamentals+</b> applies the full CMO expected-performance adjustment.</li><li>Each view has its own simulated probabilities, intervals, and chamber summaries.</li></ol></details></section>
