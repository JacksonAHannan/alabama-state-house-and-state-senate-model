...
def write_report(panel: pd.DataFrame, estimates: pd.DataFrame, issues: pd.DataFrame,
    ...
    lines = [
        ...
        "## Evidence layer", "",
        "This report is regenerated by `scripts/analyze_absolute_ideology_rebuild.py`; its tables describe the ideology-v3 evidence present when it last ran. The current bill-adjudication authority, the sponsorship evidence channel and the recomputed coverage funnel are recorded outside this generated file: `project_docs/coordination/IDEOLOGY-ROLLCALL-OPENAI-CLASSIFY-20260908.md`, `project_docs/coordination/SPONSORSHIP-IDEOLOGY-PIPELINE-20260908.md` and the dated `LEGISLATIVE_IDEOLOGY_COVERAGE_FUNNEL_*` audits under `project_docs/audits/`. Compare those records' input hashes with this report's generation before treating any table below as current; scientific acceptance of the evidence layer remains governed by the internal checklist (`ideology-04` to `ideology-11`).", "",
        "## Current reading", "",
