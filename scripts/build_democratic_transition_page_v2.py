...
<section id="methods"><div class="section-head"><div class="kicker">Coverage and interpretation</div><h2>Data and method</h2></div><h3>Full research evidence inventory</h3><p id="sourceScope">These counts cover the full research evidence file, including both parties and records outside the displayed Democratic 1998–2022 sample. They are not counts of eligible evidence used in the displayed analysis.</p><div id="sourceGrid" class="source-grid" aria-describedby="sourceScope"></div><p class="section-note" id="sourceAttribution">Source credit: roll-call and bill records from <a href="https://legiscan.com/" target="_blank" rel="noopener">LegiScan</a> (CC BY 4.0) and the Alabama Legislature; candidate questionnaires and interest-group ratings summarised from <a href="https://justfacts.votesmart.org/" target="_blank" rel="noopener">Vote Smart</a>; absolute legislator scores from Shor and McCarty (Harvard Dataverse, CC0); election identities and totals from the Alabama Secretary of State. Only derived summaries are published here; source terms and unresolved reuse questions are recorded in the repository&rsquo;s source registry and audits.</p><div class="method"><h3>WAR definition</h3><p>The residual framing follows <a href="https://split-ticket.org/2025/08/15/deconstructing-war/">Split Ticket's WAR methodology</a>; this Alabama implementation and its estimates are independent. Race WAR = actual legislative-minus-ticket gap minus the fitted structural expected gap. Democratic WAR is the race residual and Republican WAR is its exact negative. The 1998–2014 observations shown here use a backward application of the model trained only on post-2016 Southern races; 2018 and 2022 retain the published same-cycle Alabama residuals. No pooled individual effect, fundraising term, or ideology term enters WAR.</p></div><div class="method"><h3>Group construction</h3><p id="clusterMethod"></p></div><div class="method"><h3>Performance attachment</h3><p>Election performance was not used to create the groups. WAR, incumbency, fundraising, demographics, district partisanship, and era are attached only after group assignment. Adjusted comparisons use cycle-and-chamber fixed effects and person-clustered uncertainty.</p></div><div class="method"><h3>Limits</h3><p>A race residual cannot uniquely distinguish candidate strength from opponent weakness or omitted local conditions. Historical backcasts extrapolate a modern relationship. Evidence is more available for officeholders and is not missing at random; the analysis is descriptive and does not prove that an issue caused electoral performance.</p></div><div class="method"><h3>Scale comparability</h3><p>These measures are not interchangeable, and no chart mixes measurement families on one axis. The Shor–McCarty section uses the source's absolute scale, whose scores place legislators from different states and chambers on one common continuum; the displayed z-score is distance from the mean of the full national 1993–2018 legislator distribution in that scale's own standard deviation, so one standard deviation is a national scale unit, not an Alabama party, chamber, or election-cycle unit, and the Democratic candidates shown occupy only part of that national range. Issue coordinates are separate per-issue scales between the poles of that issue, oriented so positive is the more conservative Alabama position for that issue only; their magnitudes are not comparable across issues and are not Shor–McCarty units. The chamber-relative roll-call score used in the research layer is not displayed on this page. Residual WAR and the raw federal and presidential comparisons are two-party margin points against different baselines, not ideology units. Group labels, similarity-map coordinates, and evidence counts are descriptive within-sample summaries, not scales, and the grouping was formed before any performance or absolute-ideology measure was attached.</p></div></section></main><div id="tip" class="tip"></div><footer>Research and model by Jackson Hannan · <a href="cmo.html">Alabama WAR</a> · <a href="cmo-methodology.html">Methodology</a></footer>
